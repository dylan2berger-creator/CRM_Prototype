      ...
      <header className="sticky top-0 z-40 border-b border-line bg-surface">
        <div className="mx-auto flex max-w-[1600px] flex-wrap items-center gap-x-4 gap-y-2 px-4 py-2">
          <button onClick={() => navigate(config.landing)} className="flex items-center gap-2 text-left">
            <span className="grid h-7 w-7 place-items-center rounded bg-accent text-xs font-bold text-white">CR</span>
            <div className="leading-tight">
              <div className="text-sm font-semibold text-ink">
                CRM <span className="font-normal text-muted">· Client Recovery Manager</span>
              </div>
